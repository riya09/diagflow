    ...
    <div class="options">
        ...
        <div class="property">
          ...
          <label for="fill-color">
            <svg width="15" height="15" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect width="10" height="10" rx="1" :fill="fillColor"/>
            </svg>
            <input
              v-model="fillColor"
              id="fill-color"
              class="color-picker"
              type="color"
              @input="setNodeStyle(fillColor, 'fill')"
            >
          </label>
        </div>
        <div class="property">
          ...
          <label for="stroke-color">
            <svg width="15" height="15" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect width="10" height="10" rx="1" :fill="strokeColor"/>
            </svg>
            <input
              v-model="strokeColor"
              id="stroke-color"
              class="color-picker"
              type="color"
              @input="setNodeStyle(strokeColor, 'stroke')"
            >
          </label>
        </div>
        <div class="property">
          ...
          <label for="stroke-width">
            <input
              ...
              min="1"
              max="5"
              @input="setNodeStyle(strokeWidth, 'stroke-width')"
            >
          </label>
        </div>
        <div class="property">
      ...
      <label for="font-color">
        ...
        <input
          ...
          class="color-picker"
          type="color"
          @input="setTextStyle(fontColor, 'fill')"
        >
      </label>
    </div>
  </div>
...
const emit = defineEmits(['updateNodeStyle'])
